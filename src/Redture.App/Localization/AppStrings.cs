...
public sealed class AppStrings
{
    ...
    public static AppStrings English { get; } = new()
    {
        ...
        SuspendFullscreenOn = "Pauses the filter and dimming in fullscreen apps",
        SuspendFullscreenOff = "Keeps the filter and dimming in fullscreen apps",
        FullscreenActive = "An app owns the screen right now, so Redture is paused.",
    ...
    public static AppStrings Spanish { get; } = new()
    {
        ...
        SuspendFullscreenOn = "Pausa el filtro y el brillo en pantalla completa",
        SuspendFullscreenOff = "Mantiene el filtro y el brillo en pantalla completa",
        FullscreenActive = "Una aplicación tiene la pantalla completa, así que Redture está en pausa.",
