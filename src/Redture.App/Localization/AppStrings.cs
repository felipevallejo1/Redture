...
public sealed class AppStrings
{
    ...
    public static AppStrings English { get; } = new()
    {
        ...
        SuspendFullscreenOn = "Pauses the colour filter in fullscreen apps",
        SuspendFullscreenOff = "Keeps the colour filter in fullscreen apps",
        FullscreenActive = "An app owns the screen right now, so the colour filter is paused. Dimming stays.",
    ...
    public static AppStrings Spanish { get; } = new()
    {
        ...
        SuspendFullscreenOn = "Pausa el filtro de color en pantalla completa",
        SuspendFullscreenOff = "Mantiene el filtro de color en pantalla completa",
        FullscreenActive = "Una aplicación tiene la pantalla completa, así que el filtro de color está pausado. El brillo se mantiene.",
